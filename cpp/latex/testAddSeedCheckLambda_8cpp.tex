...
Add seeds to VD and check (in a greedy fashion by comparing the distance between every seed and every pixel) whether the closest seed to each pixel is the one held in its $ \lambda $ matrix entry. 
