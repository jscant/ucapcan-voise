...
const char* SKIZException::what() { return msg.c_str(); }
...
const char* SKIZLinearSeedsException::what() { return msg.c_str(); }

SKIZIndexError::SKIZIndexError(const std::string s) : SKIZException(s){}
SKIZIndexError::~SKIZIndexError() throw(){};
const char* SKIZIndexError::what() { return msg.c_str(); }
...
const char* SKIZIdenticalSeedsError::what() { return msg.c_str(); }